...
class Soal extends CI_Controller {
    ...
    public function index()
	{
        ...
        if($this->ion_auth->is_admin()){
            //Jika admin maka tampilkan semua keterampilan
            $data['keterampilan'] = $this->master->getAllKeterampilan();
        }else{
            //Jika bukan maka keterampilan dipilih otomatis sesuai keterampilan guru
            $data['keterampilan'] = $this->soal->getKeterampilanGuru($user->username);
        }
    ...
    public function add()
	{
        ...
        if($this->ion_auth->is_admin()){
            ...
            //Jika bukan maka keterampilan dipilih otomatis sesuai keterampilan guru
            $data['guru'] = $this->soal->getKeterampilanGuru($user->username);
        }
    ...
    public function save()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            if($this->ion_auth->is_admin()){
                ...
                $data['keterampilan_id'] = end($pecah);
            }else{
                $data['guru_id'] = $this->input->post('guru_id', true);
                $data['keterampilan_id'] = $this->input->post('keterampilan_id', true);
            }
