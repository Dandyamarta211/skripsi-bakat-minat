        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    <h4>Keterampilan <i class="fa fa-book pull-right"></i></h4>
                    <p><?=$keterampilan->nama_keterampilan?></p>
                </div>
                <div class="alert bg-purple">
            ...
            <div class="col-sm-4">
                <?=form_open('ujian/save', array('id'=>'formujian'), array('method'=>'edit','guru_id'=>$guru->id_guru, 'keterampilan_id'=>$keterampilan->keterampilan_id, 'id_ujian'=>$ujian->id_ujian))?>
