<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/keterampilan.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
            <?= form_open_multipart('keterampilan/preview'); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                        ...
                        <tbody>
                            <?php
                                if (empty($import)) {
                                    ...
                                    $no = 1;
                                    foreach ($import as $keterampilan) :
                                        ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $keterampilan; ?></td>
                    ...
                    <?php if (!empty($import)) : ?>
                        ...
                        <?= form_open('keterampilan/do_import', null, ['keterampilan' => json_encode($import)]); ?>
