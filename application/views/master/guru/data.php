<div class="box">
    ...
    <div class="box-body">
        <div class="mt-2 mb-4">
            <a href="<?= base_url('guru/add') ?>" class="btn btn-sm bg-green btn-flat"><i class="fa fa-plus"></i> Tambah Data Guru</a>
            <a href="<?= base_url('guru/import') ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-upload"></i> Import</a>
