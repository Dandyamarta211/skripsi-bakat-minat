        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    ...
                    <select name="keterampilan" id="keterampilan" class="form-control select2" style="width: 100%!important">
                        <option value="" disabled selected>Pilih Keterampilan</option>
                        <?php foreach ($keterampilan as $row) : ?>
                            <option <?=$data->keterampilan_id===$row->id_keterampilan?"selected":""?> value="<?=$row->id_keterampilan?>"><?=$row->nama_keterampilan?></option>
                        <?php endforeach; ?>
                    </select>
                    <small class="help-block"></small>
                </div>
