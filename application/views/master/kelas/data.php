<div class="box">
	...
	<div class="box-body">
		<div class="mt-2 mb-3">
			<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-flat bg-green"><i class="fa fa-plus"></i> Tambah Data Kelas</button>
			<a href="<?= base_url('kelas/import') ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-upload"></i> Import</a>
