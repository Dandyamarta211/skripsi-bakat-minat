                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="guru_id" class="control-label">Guru (Keterampilan)</label>
                                <?php if( $this->ion_auth->is_admin() ) : ?>
                                <select required="required" name="guru_id" id="guru_id" class="select2 form-group" style="width:100% !important">
                                    <option value="" disabled selected>Pilih Guru</option>
                                    <?php 
                                    $sdm = $soal->guru_id.':'.$soal->keterampilan_id;
                                    foreach ($guru as $d) : 
                                        $dm = $d->id_guru.':'.$d->keterampilan_id;?>
                                        <option <?=$sdm===$dm?"selected":"";?> value="<?=$dm?>"><?=$d->nama_guru?> (<?=$d->nama_keterampilan?>)</option>
                                    <?php endforeach; ?>
                                </select>
