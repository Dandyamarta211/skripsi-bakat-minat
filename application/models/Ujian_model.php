...
class Ujian_model extends CI_Model {
    ...
    {
        $this->datatables->select('a.id_ujian, a.token, a.nama_ujian, b.nama_keterampilan, a.jumlah_soal, CONCAT(a.tgl_mulai, " <br/> (", a.waktu, " Menit)") as waktu, a.jenis');
    ...
    {
        $this->datatables->select("a.id_ujian, e.nama_guru, d.nama_kelas, a.nama_ujian, b.nama_keterampilan, a.jumlah_soal, CONCAT(a.tgl_mulai, ' <br/> (', a.waktu, ' Menit)') as waktu,  (SELECT COUNT(id) FROM h_ujian h WHERE h.siswa_id = {$id} AND h.ujian_id = a.id_ujian) AS ada");
        $this->datatables->from('m_ujian a');
        $this->datatables->join('keterampilan b', 'a.keterampilan_id = b.id_keterampilan');
    ...
    public function getUjianById($id)
    {
        ...
        $this->db->join('keterampilan c', 'a.keterampilan_id=c.id_keterampilan');
    ...
    public function getSoal($id)
    {
        ...
        $this->db->where('keterampilan_id', $ujian->keterampilan_id);
    ...
    public function getHasilUjian($nip = null)
    {
        ...
        $this->datatables->select('c.nama_keterampilan, d.nama_guru');
        $this->datatables->from('h_ujian a');
        $this->datatables->join('m_ujian b', 'a.ujian_id = b.id_ujian');
        $this->datatables->join('keterampilan c', 'b.keterampilan_id = c.id_keterampilan');
